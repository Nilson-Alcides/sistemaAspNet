...
namespace ModeloDLL
{
    public class ClienteDAO
    {
        ...
        {
            string strInsert = string.Format("insert into cliente(login_id_cli, senha_cli, nome_cli, cpf_cli, telefone_cli, endereco_cli," +
                " complemento_cli, email_cli, bairro_cli, cidade_cli, uf_id_est, cep_cli) " +
